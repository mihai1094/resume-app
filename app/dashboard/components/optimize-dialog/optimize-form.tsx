        ...
        <div className="space-y-4 md:space-y-6 mt-4 md:mt-6">
            ...
            <div className="flex items-center justify-between gap-2 px-2 md:px-0">
                <div className="flex items-center gap-1.5 md:gap-2">
                    ...
                    <span className="font-medium text-sm md:text-base hidden sm:inline">Resume</span>
                </div>
                ...
                <div className="flex items-center gap-1.5 md:gap-2">
                    ...
                    <span className={cn(
                        ...
                        step2Complete || step1Complete ? "text-foreground" : "text-muted-foreground"
                    )}>
                        Job
                    </span>
                </div>
                ...
                <Select value={selectedResumeId} onValueChange={setSelectedResumeId}>
                    ...
                    <SelectContent>
                        {resumes.map((resume, index) => {
                            ...
                            const updatedAtFormatted = format(new Date(resume.updatedAt), "MMM d");
                            ...
                            <div className="flex items-center gap-2 md:gap-3 min-w-0">
                                ...
                                <div className="min-w-0">
                                    <div className="flex items-center gap-1.5">
                                        <h4 className="font-semibold text-sm">Resume Completeness</h4>
                                        <TooltipProvider>
                                            <Tooltip>
                                                ...
                                                <TooltipContent side="top" className="max-w-xs">
                                                    <p className="text-xs">
                                                        Basic check for contact info, work experience, education, and skills.
                                                        The AI analysis below provides deeper job-specific insights.
                                                    </p>
                                                </TooltipContent>
                                            </Tooltip>
                                        </TooltipProvider>
                ...
                <div className="mt-3 space-y-2">
                    <div className="flex items-center justify-between gap-2">
                        <div className="flex items-center gap-2 text-xs min-w-0">
                            <span className={cn("font-medium tabular-nums", getCharCountColor())}>
                                {charCount}
                            </span>
                            {charCount < minChars && (
            ...
            >
                {isAnalyzing ? (
                    ...
                    <>
                        ...
                        <span className="hidden sm:inline">Analyze Match & Get AI Recommendations</span>
