...
export default function TemplatesPage() {
  return (
    <div className="h-[100dvh] bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 py-4 md:py-12 relative z-10 h-full flex flex-col min-h-0">
        {/* Header */}
        <div className="mb-4 md:mb-10 shrink-0">
          <div className="flex items-center gap-3 md:mb-6">
            ...
            <h1 className="text-xl md:hidden font-semibold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-foreground to-foreground/70">
              Choose Your Template
            </h1>
          </div>
          <div className="max-w-2xl hidden md:block">
            <h1 className="text-4xl font-semibold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-foreground to-foreground/70">
              Choose Your Template
            </h1>
