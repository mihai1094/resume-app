...
export const TEMPLATES: Template[] = [
  ...
  // 3. Modern - Popular sidebar layout for tech
  {
    ...
    bestFor: "Professionals across industries who want a contemporary look that balances personality with professionalism. Ideal when applying directly to hiring managers.",
  ...
  // 4. Cubic - ATS-friendly with modern look
  {
    ...
    bestFor: "Professionals who need strong ATS compatibility without sacrificing visual appeal. Great for roles in healthcare, sciences, finance, engineering, and any field with automated screening.",
  ...
  // 10. Structured - ATS-optimized grid
  {
    ...
    bestFor: "Professionals in any field with enough experience to fill a structured two-column layout. Strong choice for healthcare, business, operations, and any role requiring ATS compliance.",
  ...
  // 14. Technical - For developers
  {
    ...
    bestFor: "Professionals with skill-forward careers in technical, analytical, or operational roles. Best when sending directly to hiring managers rather than through ATS portals.",
  ...
  // 20. Iconic - Bold headers for creative/engineering
  {
    ...
    bestFor: "Creative and technical professionals who work at the intersection of form and function. Great for companies with strong design cultures — agencies, studios, and brand-forward organizations.",
  ...
  // 23. Notion - Modern knowledge worker
  {
    id: "notion",
    name: "Notion",
    description: "Ultra-clean minimal layout inspired by modern productivity tools",
    longDescription: "Notion brings the aesthetic of modern productivity tools to your resume. Monospace code-style skill tags, muted property-label section headers, and callout blocks for achievements create a resume that speaks the visual language of the startup and tech world. Every element is intentional — no decorative lines, no colored backgrounds, just clean hierarchy and exceptional typography.",
    highlights: [
      "Monospace skill tags look like inline code — instantly recognizable to tech recruiters",
      "Muted property-label headers create a Notion-like reading experience",
      "Achievement callout blocks with accent borders draw attention to impact",
      "ATS-excellent single-column layout with zero parsing issues",
    ],
    bestFor: "Modern professionals who prefer clean, minimal layouts without sacrificing content structure. Works across industries — from technology and consulting to creative and operational roles.",
    color: "from-slate-500/10 to-gray-500/10",
    borderColor: "hover:border-slate-500/50",
    category: "professional",
    industry: "Technology",
    ...
    columns: 1,
    styleCategory: "modern",
    targetIndustries: ["Technology", "Startups", "Product", "Design"],
    features: {
      atsCompatibility: "excellent",
      customizationSupport: "full",
      supportedCustomizations: {
      ...
      hasPDFTemplate: true,
      supportsPhoto: false,
      flags: ["ats-optimized", "single-column", "minimal", "monospace-tags"],
    },
  },
  // 24. Horizon - Corporate two-column with soft blue sidebar
  {
    id: "horizon",
    name: "Horizon",
    description: "Corporate two-column with soft-tinted sidebar and portrait",
    longDescription: "Horizon is built for candidates who want warmth and credibility in equal measure. A generous square portrait anchors the pale tinted sidebar, where contact details, skills, and languages sit in quiet lists separated by hairline rules. The main column leads with a confident uppercase name in your accent color, followed by a clean Summary / Experience / Education stack where every bullet stays readable and every date stays in its lane. The palette recolors the whole frame — pick navy for classic finance, forest for sustainable industries, plum for product and design.",
    highlights: [
      "Large square portrait in a soft tinted sidebar creates immediate warmth",
      "Uppercase name in accent color reads as confident but never aggressive",
      "Hairline dividers keep the sidebar calm — every skill and language scannable at a glance",
      "Full palette customization recolors both the name and the sidebar tint in one move",
    ],
    bestFor: "Corporate professionals, financial analysts, consultants, and business candidates applying to roles where the hiring manager will read the resume personally — finance, consulting, operations, business development, and account management.",
  ...
  // 26. Nordic - Scandinavian design
  {
    id: "nordic",
    name: "Nordic",
    description: "Scandinavian design with extreme whitespace and scale-based hierarchy",
    longDescription: "Nordic applies Scandinavian design principles to resume building — less is more, and what remains must be perfect. A massive serif name anchors the page, while sections are separated by whitespace alone, with no lines, borders, or decorative elements. The asymmetric two-column layout uses empty space as a design element rather than something to fill. Every pixel of silence is intentional.",
    highlights: [
      "Massive serif name creates an unforgettable first impression",
      "Hierarchy through scale and whitespace — no visual clutter",
      "Two-column layout with invisible separation via whitespace",
      "Photo support with understated circular crop",
    ],
    bestFor: "Designers, architects, academics, and creative professionals who appreciate restraint and believe their work should speak louder than their resume's design.",
  ...
  // 27. Sydney - Colored header band + clean single-column body
  {
    id: "sydney",
    name: "Sydney",
    description: "Bold colored header band with clean single-column body",
    longDescription: "Sydney's full-width accent-colored header instantly sets it apart — your name and title appear in crisp white against a rich background, with contact details in a single compact row. Below, a clean single-column layout with accent-colored section labels keeps the content readable by any ATS while maintaining strong visual identity. Inspired by the world's most downloaded resume formats (Resume.io Stockholm/Sydney, Zety Cascade), this is the template millions of job seekers reach for when they want professional polish without visual clutter.",
    highlights: [
      "Full-width colored header band creates immediate visual authority",
      "White-on-color name treatment — the most globally downloaded resume format",
      "Single-column body ensures excellent ATS compatibility",
      "Skills shown as subtle accent-colored pill tags",
    ],
    bestFor: "Professionals across all industries who want a visually distinctive template that still passes ATS screening. Particularly effective in business, finance, marketing, and any field where professional presentation matters.",
    ...
    columns: 1,
    styleCategory: "modern",
    targetIndustries: ["General", "Business", "Finance", "Marketing", "Technology"],
    features: {
      atsCompatibility: "good",
      customizationSupport: "full",
      supportedCustomizations: {
      ...
      supportsPhoto: true,
      photoShape: "circular",
      flags: ["colored-header", "photo", "single-column"],
    },
  },
];
