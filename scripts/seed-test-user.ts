...
function createCompleteResume() {
  return {
    ...
    skills: [
      { id: "s-1", name: "TypeScript", category: "Technical Skills", level: "expert" },
      { id: "s-2", name: "JavaScript", category: "Technical Skills", level: "expert" },
      { id: "s-3", name: "React", category: "Technical Skills", level: "expert" },
      { id: "s-4", name: "Node.js", category: "Technical Skills", level: "advanced" },
      { id: "s-5", name: "PostgreSQL", category: "Tools & Technologies", level: "advanced" },
      { id: "s-6", name: "AWS", category: "Tools & Technologies", level: "advanced" },
      { id: "s-7", name: "Docker", category: "Tools & Technologies", level: "intermediate" },
